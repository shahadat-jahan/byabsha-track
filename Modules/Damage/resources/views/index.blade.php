...
<div class="damage-shell">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3 damage-header">
        <div>
            ...
            <h1 class="page-title display-font mb-1"><i class="bi bi-exclamation-triangle"></i> {{ __('damage.title') }}</h1>
            <p class="page-subtitle mb-0">{{ __('damage.subtitle') }}</p>
        </div>
        <a href="{{ route('damage.create') }}" class="btn-new-damage shadow-sm">
            <i class="bi bi-plus-circle"></i> {{ __('damage.record_damage') }}
        </a>
    </div>
    ...
    <div class="filter-toolbar mb-4 shadow-sm">
        <form method="GET" action="{{ route('damage.index') }}" class="m-0 w-100" id="filterForm">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-md-2">
                    <button class="btn btn-filter-submit w-100" type="submit">
                        <i class="bi bi-funnel"></i> {{ __('damage.apply_filters') }}
                    </button>
                </div>
            </div>
        </form>
