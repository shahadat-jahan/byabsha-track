...
<div class="sale-shell">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3 sale-header">
        <div>
            ...
            <h1 class="page-title display-font mb-1"><i class="bi bi-arrow-left-right"></i> {{ __('sale.exchange_title') }}</h1>
            <p class="page-subtitle mb-0">{{ __('sale.exchange_subtitle') }}</p>
        </div>
        <a href="{{ route('sale.exchanges.create') }}" class="btn-new-sale shadow-sm">
    ...
    <div class="filter-toolbar mb-4 shadow-sm">
        <form method="GET" action="{{ route('sale.exchanges.index') }}" class="m-0 w-100" id="filterForm">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var table = $('#exchangesDataTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{ route("sale.exchanges.table") }}',
                data: function (d) {
