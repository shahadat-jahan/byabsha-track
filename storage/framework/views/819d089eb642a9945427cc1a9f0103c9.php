...
<div class="damage-shell">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3 damage-header">
        <div>
            ...
            <h1 class="page-title display-font mb-1"><?php echo e(__('damage.create_title')); ?></h1>
            <p class="page-subtitle mb-0"><?php echo e(__('damage.create_subtitle')); ?></p>
        </div>
        <a href="<?php echo e(route('damage.index')); ?>" class="btn-back-custom shadow-sm">
            <i class="bi bi-arrow-left"></i> <?php echo e(__('damage.back_to_list')); ?>

        </a>
    </div>

    <form method="POST" action="<?php echo e(route('damage.store')); ?>" id="damageForm" class="m-0">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-card mb-4">
            ...
            <div class="form-card-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="form-label form-label-custom"><?php echo e(__('damage.shop')); ?> *</label>
                        <select class="form-select form-select-custom <?php $__errorArgs = ['shop_id'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        <label class="form-label form-label-custom"><?php echo e(__('damage.damage_date')); ?> *</label>
                        <input type="date" class="form-control form-control-custom <?php $__errorArgs = ['damage_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        <label class="form-label form-label-custom"><?php echo e(__('damage.note')); ?></label>
                        <input type="text" class="form-control form-control-custom <?php $__errorArgs = ['note'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-card mb-4">
            <div class="form-card-header d-flex justify-content-between align-items-center">
                <h5 class="form-card-title">
                    ...
                    <?php echo e(__('damage.line_items')); ?>

                </h5>
                <button type="button" class="btn btn-add-line" id="addLineBtn">
                    <i class="bi bi-plus-circle me-1"></i><?php echo e(__('damage.add_line')); ?>
        ...
        <div class="d-flex justify-content-end mb-4">
            <button type="submit" class="btn-submit-premium">
                ...
                <?php echo e(__('damage.record_damage')); ?>
    ...
    function addLine(defaults = {}) {
        ...
        row.innerHTML = `
            <div class="row g-3 align-items-end">
                <div class="col-lg-4">
                    <label class="form-label form-label-custom">${<?php echo json_encode(__('damage.batch'), 15, 512) ?>} *</label>
                ...
                <div class="col-lg-2">
                    <label class="form-label form-label-custom">${<?php echo json_encode(__('damage.quantity'), 15, 512) ?>} *</label>
                ...
                <div class="col-lg-2">
                    <label class="form-label form-label-custom">${<?php echo json_encode(__('damage.purchase_price'), 15, 512) ?>}</label>
                    <input type="text" class="form-control form-control-custom purchase-price-input" readonly>
                </div>
                <div class="col-lg-2">
                    <label class="form-label form-label-custom">${<?php echo json_encode(__('damage.reason'), 15, 512) ?>}</label>
                ...
                <div class="col-lg-2 text-end">
                    <button type="button" class="btn btn-outline-danger remove-line-btn btn-sm" style="height: 38px; border-radius: 10px; width: 100%;">
                        <i class="bi bi-trash me-1"></i>${<?php echo json_encode(__('damage.remove_line'), 15, 512) ?>}
                    </button>
                </div>
                <div class="col-12">
                    <label class="form-label form-label-custom">${<?php echo json_encode(__('damage.reason_note'), 15, 512) ?>}</label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\byabsha-track\Modules/Damage\resources/views/create.blade.php ENDPATH**/ ?>